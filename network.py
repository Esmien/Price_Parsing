...
class GoogleSheetsClient:
    ...
    def connect(self):
        ...
        try:
            ...
            self.sh = self.client.open(self.spreadsheet_title)
    ...
    def update_sheet(self, sheet_name: str, products: List[Product]):
        """
        ...
        try:
            ...
            worksheet = self.sh.add_worksheet(title=sheet_name, rows=1000, cols=10)
